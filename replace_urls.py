...
def replacingtexts(old1,new1):
	...
	try:
		f1 = open('/var/www/html/script.js', 'r')
		f2 = open('/var/www/html/script_copy.js', 'w')
		for line in f1:
			f2.write(line.replace(old1, new1))
		f1.close()
		f2.close()
		...
		import os
		os.remove("/var/www/html/script.js")
		os.rename('/var/www/html/script_copy.js', '/var/www/html/script.js')	
	except:
		pass
